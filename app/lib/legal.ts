...
export const REPORT_EMAIL = "midnightworldplatform@gmail.com";
export const SUPPORT_EMAIL = "midnightworldplatform@gmail.com";
export const PRIVACY_EMAIL = "midnightworldplatform@gmail.com";
...
export function buildReportMailto(creatorId: number, creatorName?: string): string {
  ...
  const lines = [
    ...
    `URL: https://midnight24.cam/creator/${creatorId}`,
    ``,
    `Reason (please describe what you observed):`,
    ``,
    `---`,
    `Midnight safety policy: https://midnight24.cam/safety`,
  ].filter(Boolean);
